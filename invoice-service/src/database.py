...
def upsert_invoice_processing(
    ...
    """Speichert den Beginn eines Rechnungsversuchs idempotent."""
    query = """
...
def mark_invoice_created(invoice_id: str, pdf_path: str, attempts: int) -> None:
    """Markiert einen Rechnungsversuch als erfolgreich."""
    query = """
    UPDATE invoices
...
def mark_invoice_failed(invoice_id: str, error: str, attempts: int) -> None:
    """Markiert einen Rechnungsversuch als fehlgeschlagen."""
    query = """
    UPDATE invoices

...
# Queue fuer Commands des Billing-Service.
...
def consume_messages(
    ...
    while not stop_event.is_set():
        ...
        try:
            ...
            # Manuelle Bestaetigung erst nach erfolgreicher Verarbeitung.
            for method_frame, properties, body in channel.consume(
                ...
                if method_frame is None:
                    continue  # Timeout ohne Nachricht
                try:
                    handle_message(json.loads(body.decode("utf-8")))
                    channel.basic_ack(method_frame.delivery_tag)
                except Exception:
                    # Fehlerhafte Nachrichten nicht erneut zustellen.
